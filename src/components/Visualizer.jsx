...
const Visualizer = ({ audioData, isListening, intensity = 0, width = 600, height = 400 }) => {
    ...
    return (
        <div className="relative" style={{ width, height }}>
            {/* Central Logo/Text - wrapper with translate(-50%,-50%) for true center with letter-spacing */}
            <div className="absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                    <motion.div
                        animate={{ scale: isListening ? [1, 1.1, 1] : 1 }}
                        transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
                        className="text-cyan-100 font-bold tracking-[0.3em] drop-shadow-[0_0_15px_rgba(34,211,238,0.8)] whitespace-nowrap"
